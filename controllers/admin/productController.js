...
export const addProduct = async (req, res) => {
    try {
        ...
        const [engineResult] = await connect.execute(
            "INSERT INTO products (cat_id, p_name, p_price, discount, p_main_price, p_url, p_title, p_desc, p_key_features, tags, brand, sku, colour, type, new_arrival, best_seller, p_image, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())",
            [cat_id, p_name, p_price, discount, p_main_price, p_url, p_title, p_desc, p_key_features, tags, brand, sku, colour, type, new_arrival, best_seller, main_image_path]
        );
